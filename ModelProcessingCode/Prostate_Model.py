...
class ProstateModelBuilder(BaseModelBuilder):
    ...
    def run_prediction(self):
        ...
        write_files = [i for i in files if i.startswith('CTV_Prostate') and not i.endswith('.mhd')
...
def return_prostate_model():
    ...
    model_path_base = os.path.join(local_path, 'Models', 'Prostate')
    models = [
        os.path.join(model_path_base, 'Model_2', 'model.keras')
              ]
    ...
    roi_base_name = 'CTV_Prostate_AI_Prediction'
    ...
    image_processors = [
        ...
        Processors.Resampler(desired_output_spacing=(0.9765, 0.9765, 2.0), resample_keys=dicom_handle_key,
    ...
    prediction_processors = [
        ...
        Processors.MinimumVolumeandAreaPrediction(prediction_keys=prediction_keys, min_volume=10.0,
